  	...
  	<nav id="site-navigation" class="main-nav" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu','medical-care' ); ?>">
        <div class="site-header__util">
            ...
            if(is_user_logged_in()){ ?>
                  ...
                  ?>
              <a href="<?php echo wp_registration_url(); ?>" class="btn btn--small btn--orange float-right push-right">Signup</a>
              <a href="<?php echo wp_login_url() ?>" class="btn btn--small btn--orange float-right push-right">Login</a>
            <?php }
            ?>
