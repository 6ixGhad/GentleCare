...
<?php $post_option = get_theme_mod( 'medical_care_grid_column','3_column');
	...
	<div id="Category-section" class="entry-content">
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="postbox smallpostimage">
	        	...
	        	<div class="overlay">
	        		<div class="date-box">
	        			<?php if( get_theme_mod('medical_care_date',true) != ''){ ?>
	        				<span><i class="far fa-calendar-alt"></i><?php the_time( get_option( 'date_format' ) ); ?></span>
	        			<?php }?>
	        			<?php if( get_theme_mod('medical_care_admin',true) != ''){ ?>
	        			...
	        			<?php }?>
	        			<?php if( get_theme_mod('medical_care_comment',true) != ''){ ?>
